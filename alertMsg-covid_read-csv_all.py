...
data3 = dataset_train1.loc[dataset_train1["CATEGORY"] == "개인방역수칙"]
data4 = dataset_train1.loc[dataset_train1["CATEGORY"] == "발생현황"]
data5 = dataset_train1.loc[dataset_train1["CATEGORY"] == "행정안내"]
# new_data = data1.append([data2, data3], sort=False)
# new_df = pd.DataFrame(new_data)
new_df1 = pd.DataFrame(data1)
new_df1 = new_df1.sample(frac=1).head(10000)
new_data = data2.append([data3, data4, data5], sort=False)
new_df = pd.DataFrame(new_data)
