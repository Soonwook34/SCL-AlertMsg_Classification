...
def run_KoBERT():
    ...
    dataset_train = nlp.data.TSVDataset("covid_train_main.txt", field_indices=[1, 2], num_discard_samples=1)
    dataset_test = nlp.data.TSVDataset("covid_test_main.txt", field_indices=[1, 2], num_discard_samples=1)
